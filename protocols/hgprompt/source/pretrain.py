...
from protocols.hgprompt.utils.data import load_pretrain_data
#from utils.tools import index_generator, evaluate_results_nc, parse_minibatch
from protocols.hgprompt.source.GNN import GCN, GAT, GIN,acm_hGCN,acm_sem_hGCN,acm_hGCN_each_loss,dblp_hGAT,freebase_bi_hGCN\
    ...
    for _ in range(args.repeat):
        ...
        if args.model_type=='SHGN':
            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                           save_path='artifacts/checkpoints/hgprompt/pretrain/shgn_checkpoint_{}_{}.pt'.format(args.dataset, args.num_layers))
        else:
            if args.dataset=='Freebase':
                if args.hetero_pretrain:
                    if args.hetero_subgraph:
                        if args.semantic_weight:
                            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                           save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_semantic_{}_{}_{}_{}_{}_{}_{}.pt'.
                            ...
                            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                           save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_each_loss_{}_{}_{}_{}_{}_{}_{}.pt'.
                                                           format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                                  args.loss_weight, args.feats_type,args.tuple_neg_disconnected_num,args.tuple_neg_unrelated_num))

                        else:
                            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                           save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_{}_{}_{}_{}_{}_{}_{}.pt'.
                                                           format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                                  args.loss_weight, args.feats_type,args.tuple_neg_disconnected_num,args.tuple_neg_unrelated_num))
                    else:
                        early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                       save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_{}_{}_{}_{}_{}_{}_{}.pt'.
                                                       format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                              args.loss_weight, args.feats_type,args.tuple_neg_disconnected_num,args.tuple_neg_unrelated_num))
                else:
                    if args.hetero_subgraph:
                        if args.semantic_weight:
                            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                           save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_semantic_{}_{}_{}_{}_{}_{}.pt'.
                                                           format(args.dataset, args.model_type, args.subgraph_hop_num,
                            ...
                            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                           save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_{}_{}_{}_{}_{}_{}.pt'.
                                                           format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                                  args.feats_type,args.tuple_neg_disconnected_num,args.tuple_neg_unrelated_num))
                    else:
                        early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                       save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_{}_{}_{}_{}_{}_{}.pt'.
                                                       format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                              args.feats_type,args.tuple_neg_disconnected_num,args.tuple_neg_unrelated_num))
                ...
                if args.hetero_pretrain:
                    if args.hetero_subgraph:
                        if args.semantic_weight:
                            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                           save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_semantic_{}_{}_{}_{}_{}.pt'.
                                                           format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                                  args.loss_weight, args.feats_type))
                        elif args.each_loss:
                            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                           save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_each_loss_{}_{}_{}_{}_{}.pt'.
                                                           format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                                  args.loss_weight, args.feats_type))

                        else:
                            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                           save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_{}_{}_{}_{}_{}.pt'.
                                                           format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                                  args.loss_weight, args.feats_type))
                    else:
                        early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                       save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_{}_{}_{}_{}_{}.pt'.
                                                       format(args.dataset, args.model_type,args.subgraph_hop_num,args.loss_weight,args.feats_type))
                else:
                    if args.hetero_subgraph:
                        if args.semantic_weight:
                            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                           save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_semantic_{}_{}_{}_{}.pt'.
                                                           format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                                  args.feats_type))
                        elif args.each_loss:
                            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                            ...
                            early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                           save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_{}_{}_{}_{}.pt'.
                                                           format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                                  args.feats_type))
                    else:
                        early_stopping = EarlyStopping(patience=args.patience, verbose=True,
                                                       save_path='artifacts/checkpoints/hgprompt/pretrain/checkpoint_{}_{}_{}_{}.pt'.
