...
import os
# sys.path.append('..')
from protocols.hgprompt.utils.pytorchtools import EarlyStopping
from protocols.hgprompt.utils.data import load_data
#from utils.tools import index_generator, evaluate_results_nc, parse_minibatch
from protocols.hgprompt.source.GNN import GCN, GAT, GIN,semantic_GCN,myGAT
import dgl
    ...
    for count in range(args.tasknum):
        ...
        for _ in range(args.repeat):
            ...
            if args.model_type == 'SHGN':
                net.load_state_dict(torch.load('artifacts/checkpoints/hgprompt/pretrain/shgn_checkpoint_{}_{}.pt'.format(
                    ...
                    if args.load_pretrain:
                        if args.hetero_pretrain:
                            if args.hetero_pretrain_subgraph:
                                if args.pretrain_semantic:
                                    net.load_state_dict(
                                        torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_semantic_{}_{}_{}_{}_{}_{}_{}.pt'.
                                    ...
                                    net.load_state_dict(
                                        torch.load(
                                            'artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_each_loss_{}_{}_{}_{}_{}_{}_{}.pt'.
                                            format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                   args.pre_loss_weight, args.feats_type,args.tuple_neg_disconnected_num,args.tuple_neg_unrelated_num)))

                                else:
                                    net.load_state_dict(
                                        torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_{}_{}_{}_{}_{}_{}_{}.pt'.
                                                   format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                          args.pre_loss_weight, args.feats_type,args.tuple_neg_disconnected_num,args.tuple_neg_unrelated_num)))
                            else:
                                net.load_state_dict(
                                    torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_{}_{}_{}_{}_{}_{}_{}.pt'.
                                               format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                      args.pre_loss_weight, args.feats_type,args.tuple_neg_disconnected_num,args.tuple_neg_unrelated_num)))
                        else:
                            if args.hetero_pretrain_subgraph:
                                if args.pretrain_semantic:
                                    net.load_state_dict(
                                        torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_semantic_{}_{}_{}_{}_{}_{}.pt'.
                                                   format(args.dataset, args.model_type, args.subgraph_hop_num,
                                    ...
                                    net.load_state_dict(
                                        torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_{}_{}_{}_{}_{}_{}.pt'.
                                                   format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                          args.feats_type,args.tuple_neg_disconnected_num,args.tuple_neg_unrelated_num)))
                            else:
                                net.load_state_dict(
                                    torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_{}_{}_{}_{}_{}_{}.pt'.
                                               format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                      args.feats_type,args.tuple_neg_disconnected_num,args.tuple_neg_unrelated_num)))
    ##################### end of if freebase#############
                else:
                    if args.load_pretrain:
                        if args.hetero_pretrain:
                            if args.hetero_pretrain_subgraph:
                                if args.pretrain_semantic:
                                    net.load_state_dict(
                                        torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_semantic_{}_{}_{}_{}_{}.pt'.
                                                   format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                          args.pre_loss_weight, args.feats_type)))
                                elif args.pretrain_each_loss:
                                    net.load_state_dict(
                                        torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_each_loss_{}_{}_{}_{}_{}.pt'.
                                                   format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                          args.pre_loss_weight, args.feats_type)))

                                else:
                                    net.load_state_dict(
                                        torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_{}_{}_{}_{}_{}.pt'.
                                                   format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                          args.pre_loss_weight, args.feats_type)))
                            else:
                                net.load_state_dict(
                                    torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_{}_{}_{}_{}_{}.pt'.
                                                       format(args.dataset, args.model_type,args.subgraph_hop_num,args.pre_loss_weight,args.feats_type)))
                        else:
                            if args.hetero_pretrain_subgraph:
                                if args.pretrain_semantic:
                                    net.load_state_dict(
                                        torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_semantic_{}_{}_{}_{}.pt'.
                                                   format(args.dataset, args.model_type, args.subgraph_hop_num,
                                                          args.feats_type)))
                                elif args.pretrain_each_loss:
                                    net.load_state_dict(
                                    ...
                                    net.load_state_dict(
                                        torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_hsubgraph_{}_{}_{}_{}.pt'.
                                                   format(args.dataset, args.model_type, args.subgraph_hop_num, args.feats_type)))
                            else:
                                net.load_state_dict(
                                    torch.load('artifacts/checkpoints/hgprompt/pretrain/checkpoint_{}_{}_{}_{}.pt'.
                                                       format(args.dataset, args.model_type,args.subgraph_hop_num,args.feats_type)))
            net.to(device)
            if args.pretrain_semantic:
            ...
            early_stopping_classify = EarlyStopping(patience=args.patience, verbose=True,
                                           save_path='artifacts/checkpoints/hgprompt/checkpoint_{}_{}_{}_freeze_classify.pt'.format(args.dataset,
