...
mkdir -p artifacts/results/mug_peprompt/acm_mug_fixed_split_r60_mug50_full_edges
...
/home_A/yuanqilin/.conda/envs/HGEP/bin/python -u scripts/mug_peprompt_benchmark.py \
  ...
  --out_dir artifacts/results/mug_peprompt/acm_mug_fixed_split_r60_mug50_full_edges \
  2>&1 | tee artifacts/logs/mug_peprompt/acm_mug_fixed_split_r60_mug50_full_edges.log
