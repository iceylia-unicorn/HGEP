...
mkdir -p artifacts/logs/mug_peprompt/prompt_constraints
mkdir -p artifacts/results/mug_peprompt/acm_mug_fixed_split_prompt_constraints
...
run_one() {
  ...
  local out_dir="artifacts/results/mug_peprompt/acm_mug_fixed_split_prompt_constraints/${tag}"
  local log_path="artifacts/logs/mug_peprompt/prompt_constraints/acm_fixed_${tag}.log"
